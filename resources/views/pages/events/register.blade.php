        ...
        <div class="row mb-3">
            <div class="col-xl-8">
                ...
                <form action="{{ route('events.register.post') }}" method="POST" id="register-form">
                    ...
                    <input type="hidden" name="event_registration_fee" id="event-registration-fee-field" value="{{ $event->reg_fee }}">
                            ...
                            <div class="table-responsive">
                                <table class="table table-borderless mb-0">
                                    <tbody>
                                        <tr>
                                            <td>Sub Total :</td>
                                            <td class="text-end" id="registration-subtotal">₱ {{ number_format($event->reg_fee,2) }}</td>
                                        </tr>
                                        <tr>
                                            <td>Donation : </td>
