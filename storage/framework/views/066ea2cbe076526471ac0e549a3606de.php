...
<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('translation.roles'); ?>
    ...
    <div class="row">
        <div class="col-lg-12">
                    ...
                    <div class="flex-shrink-0">
                        <div class="d-flex flex-wrap gap-2">
                            <button type="button" class="btn btn-primary add-btn text-capitalize" data-bs-toggle="modal"
                                ...
                                <i class="ri-add-line align-bottom me-1"></i>Add new role</button>
            ...
            <div class="card" id="ticketsList">
                <div class="card-body">
                    <table id="roles_datatables" class="table nowrap align-middle table-striped" style="width:100%">
                        <thead>
                            <tr>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#roles_datatables').on('draw.dt', function() {
                ...
                $('.remove-btn').click(function() {
                    ...
                    showDeleteMessage({
                        message: '<strong class="text-danger">Removing this role</strong> will remove all of the information from our database.',
            ...
            function initializeTables() {
                ...
                let table = $("#roles_datatables").DataTable({
                    processing: true,
                    pageLength: 10,
                    responsive: true,
                    serverSide: true,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GodesQ\MFC_Portal_V2\resources\views/pages/roles/list.blade.php ENDPATH**/ ?>