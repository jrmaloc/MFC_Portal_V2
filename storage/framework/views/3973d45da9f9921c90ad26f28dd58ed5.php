                        ...
                        <ul class="nav nav-sm flex-column">
                            <li
                                ...
                                <a href="<?php echo e(route('events.index')); ?>"
                                    class="nav-link <?php echo e(preg_match('/^dashboard\/events/', Request::path()) ? 'active' : ''); ?>"><?php echo app('translator')->get('translation.list'); ?></a>
                            </li>
                            <li
                                class="nav-item <?php echo e(preg_match('/^dashboard\/calendar/', Request::path()) ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('events.index', ['section' => 'calendar'])); ?>"
                                    class="nav-link <?php echo e(preg_match('/^dashboard\/events\/calendar/', Request::path()) ? 'active' : ''); ?>"><?php echo app('translator')->get('translation.calendar'); ?></a>
                            </li>
                        </ul>
                    </div>
                </li>
