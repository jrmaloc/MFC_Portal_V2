...
<head>
    ...
    <title><?php echo e($event->title); ?> | MFC Event</title>
...
<body>
    ...
    <nav class="main-nav">
        <div class="d-flex justify-content-between align-items-center">
            <img class="rounded-circle" style="width: 60px;" src="<?php echo e(URL::asset('build/images/MFC-Logo.jpg')); ?>" alt="">
            <?php if(auth()->user()): ?>
                <div>
                    <a href="<?php echo e(route('dashboards.index')); ?>" class="btn btn-primary">Dashboard</a>
                </div>
            <?php else: ?>
                <ul class="mb-[0px] d-flex gap-3">
                    <li><a href="<?php echo e(route('login')); ?>" class="btn btn-primary-50">Login</a></li>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="event-details my-3">
                            ...
                            <?php if($event->is_enable_event_registration): ?>
                        ...
                        <input type="hidden" name="latitude" id="latitude" value="<?php echo e($event->latitude); ?>">
                        <input type="hidden" name="longitude" id="longitude" value="<?php echo e($event->longitude); ?>">
                    </div>
                </div>
