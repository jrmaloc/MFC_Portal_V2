                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    <button type="button"
                        ...
                        <?php switch(Session::get('lang')):
                            ...
                            <?php case ('ae'): ?>
                                <img src="<?php echo e(URL::asset('build/images/flags/ae.svg')); ?>" class="rounded" alt="Header Language"
                                    height="20">
                            <?php break; ?>

                            <?php default: ?>
                                <img src="<?php echo e(URL::asset('build/images/flags/us.svg')); ?>" class="rounded" alt="Header Language"
                                    height="20">
                        <?php endswitch; ?>
                    </button>
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                        ...
                        <div class="tab-content position-relative" id="notificationItemsTabContent">
                            <div class="tab-pane fade show active py-2 ps-2" id="all-noti-tab" role="tabpanel">
                                <div data-simplebar style="max-height: 300px;" class="pe-2 position-relative">
                                ...
                                <div class="my-2 text-center view-all">
                    ...
                    <button type="button" class="btn material-shadow-none" id="page-header-user-dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user"
                                src="<?php if(Auth::user()->avatar != ''): ?> <?php echo e(URL::asset('build/images/users/' . Auth::user()->avatar)); ?><?php else: ?><?php echo e(URL::asset('build/images/users/avatar-1.jpg')); ?> <?php endif; ?>"
                                alt="Header Avatar">
...
<?php /**PATH C:\Users\GoDesQ3\Downloads\MFC_Portal_V2\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>