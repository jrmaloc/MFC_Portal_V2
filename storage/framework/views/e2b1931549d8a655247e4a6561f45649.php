                    ...
                    <div class="card">
                        ...
                        <div class="card-header bg-light-subtle border-bottom-dashed">
                            ...
                            <div class="hstack gap-3 px-3 mx-n3">
                                <input class="form-control me-auto" type="text" placeholder="Enter donation amount" aria-label="Add donation amount here...">
    ...
    <script>
        ...
        function computeTotalAmount() {
            ...
            for (let i = 0; i < user_ids.length; i++) {
                totalAmount += Number(eventRegistrationFee);
            }
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GodesQ\MFC_Portal_V2\resources\views/pages/events/register.blade.php ENDPATH**/ ?>