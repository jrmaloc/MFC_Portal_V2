                    ...
                    <div class="border-top border-top-dashed pt-3 mt-3">
                        ...
                        <div class="mt-2 vstack email-chat-list mx-n4">
                            <a href="javascript: void(0);" class="d-flex align-items-center active">
                                <div class="flex-shrink-0 me-2 avatar-xxs chatlist-user-image">
                                    <img class="img-fluid rounded-circle"
                                        src="<?php echo e(URL::asset('build/images/users/avatar-2.jpg')); ?>" alt="">
                                </div>
                            ...
                            <a href="javascript: void(0);" class="d-flex align-items-center">
                                <div class="flex-shrink-0 me-2 avatar-xxs chatlist-user-image">
                                    <img class="img-fluid rounded-circle"
                                        src="<?php echo e(URL::asset('build/images/users/avatar-4.jpg')); ?>" alt="">
                                </div>
                            ...
                            <a href="javascript: void(0);" class="d-flex align-items-center">
                                <div class="flex-shrink-0 me-2 avatar-xxs chatlist-user-image">
                                    <img class="img-fluid rounded-circle"
                                        src="<?php echo e(URL::asset('build/images/users/avatar-3.jpg')); ?>" alt="">
                                </div>
                            ...
                            <a href="javascript: void(0);" class="d-flex align-items-center">
                                <div class="flex-shrink-0 me-2 avatar-xxs chatlist-user-image">
                                    <img class="img-fluid rounded-circle"
                                        src="<?php echo e(URL::asset('build/images/users/avatar-5.jpg')); ?>" alt="">
                                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\GoDesQ3\Downloads\MFC_Portal_V2\resources\views/apps-mailbox.blade.php ENDPATH**/ ?>