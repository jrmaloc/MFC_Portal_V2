    ...
    <div class="modal fade zoomIn" id="createModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0">
                ...
                <form class="announcements_tablelist_form" autocomplete="off" action="<?php echo e(route('announcements.store')); ?>"
                    method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="modal-footer">
                        <div class="hstack gap-2 justify-content-end">
                            ...
                            <button type="submit" class="btn btn-success" id=""><?php echo app('translator')->get('translation.create_announcement'); ?></button>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        $(document).ready(function() {
            var announcements = <?php echo json_encode($announcements, 15, 512) ?>;
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\GoDesQ3\Downloads\MFC_Portal_V2\resources\views/pages/announcements/index.blade.php ENDPATH**/ ?>