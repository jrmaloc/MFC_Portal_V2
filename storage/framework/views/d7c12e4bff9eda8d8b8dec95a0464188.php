...
unset($__errorArgs, $__bag); ?>" name="password" placeholder="Enter password" id="password-input" value="Test123!">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mt-4 text-center">
                        <p class="mb-0">Don't have an account? <a href="<?php echo e(route('register')); ?>" class="fw-semibold text-primary text-decoration-underline"> Sign Up </a> </p>
                    </div>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GodesQ\MFC_Portal_V2\resources\views/auth/login.blade.php ENDPATH**/ ?>